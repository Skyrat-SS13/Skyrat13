...
/*/obj/effect/mob_spawn/human/
	...
	desc = "A humming cryo pod. You can barely recognise a [job uniform] underneath the built up ice. The machine is attempting to wake up its occupant."
	mob_name = "a [job title]"
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper"
	roundstart = FALSE
	death = FALSE
	random = TRUE
	mob_species = /datum/species/human
	short_desc = "You are a [job] working for Nanotrasen, stationed onboard a state of the art research station."
...
/obj/effect/mob_spawn/human/oldmed
	...
	random = TRUE
	mob_species = /datum/species/human
	short_desc = "You are a medical doctor working for Nanotrasen, stationed onboard a state of the art research station."
	flavour_text = "You vaguely recall rushing into a cryogenics pod due to an oncoming radiation storm. \
	The last thing you remember is the station's Artificial Program telling you that you would only be asleep for eight hours. As you open \
	your eyes, everything seems rusted and broken, a dark feeling swells in your gut as you climb out of your pod."
	important_info = "Work as a team with your fellow survivors and do not abandon them."
...
/obj/effect/mob_spawn/human/oldass
	name = "old cryogenics pod"
	desc = "A humming cryo pod. You can barely recognise a gray jumpsuit underneath the built up ice. The machine is attempting to wake up its occupant."
...
/obj/effect/mob_spawn/human/oldchap
	name = "old cryogenics pod"
	desc = "A humming cryo pod. You can barely recognise a clergy jumpsuit underneath the built up ice. The machine is attempting to wake up its occupant."
	mob_name = "a chaplain"
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper"
	roundstart = FALSE
	...
	id = /obj/item/card/id/away/old/chap
	job_description = "Oldstation Crew"
	assignedrole = "Ancient Crew"

/datum/oldchap/after_spawn(mob/living/H, mob/M)
	. = ..()
	if(H.mind)
		H.mind.isholy = TRUE
	...
	H.equip_to_slot_or_del(B, SLOT_IN_h)
