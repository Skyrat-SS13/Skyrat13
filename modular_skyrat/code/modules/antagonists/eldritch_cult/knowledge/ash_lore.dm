/datum/eldritch_knowledge/base_ash
	...
	desc = "Opens up the path of ash to you. Allows you to transmute an Ashen Blade into existance at a cost of 1 charge."
...
/datum/eldritch_knowledge/ashen_eyes
	...
	desc = "Allows you to create a thermal vision amulet at a cost of 2 charges."
	cost = 5
...
/datum/eldritch_knowledge/curse/blindness
	...
	desc = "Curse someone with 2 minutes of complete blindness  at a cost of 2 charges and an item that the victim touched  with their bare hands"
	cost = 5
	charges_needed = 2
...
/datum/eldritch_knowledge/curse/corrosion
	...
	desc = "Curse someone for 2 minutes of vomiting and major organ damage at a cost of 2 charges and an item that the victim touched  with their bare hands."
	cost = 5
	charges_needed = 2
...
/datum/eldritch_knowledge/curse/paralysis
	...
	desc = "Curse someone for 5 minutes of inability to walk at a cost of 2 charges and an item that the victim touched  with their bare hands"
	cost = 5
	charges_needed = 2
...
/datum/eldritch_knowledge/final/ash_final/on_finished_recipe(mob/living/user,mob/living/carbon/human/buckled,loc)
	priority_announce("$^@&#*$^@(#&$(@&#^$&#^@# Fear the blaze, for Heir to the throne of Ash [user.real_name] has come! $^@&#*$^@(#&$(@&#^$&#^@#","#$^@&#*$^@(#&$(@&#^$&#^@#", 'sound/announcer/classic/spanomalies.ogg')
