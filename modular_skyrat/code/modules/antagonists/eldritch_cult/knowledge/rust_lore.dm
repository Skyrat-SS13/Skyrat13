...
/datum/eldritch_knowledge/final/rust_final
	...
	desc = "To gain this spell you must sacrifice at least 5 people, and the ritual costs 5 charges. After you finish the ritual rust will now automatically spread from the rune. Your healing on rust is also tripled, while you become more resillient overall."
