...
/obj/structure/closet/crate/necropolis/dragon/PopulateContents()
	...
	var/loot = pick(/obj/item/melee/ghost_sword, /obj/item/lava_staff, list(/obj/item/book/granter/spell/sacredflame, /obj/item/gun/magic/wand/fireball), /obj/item/dragons_blood)
	if(!islist(loot))
		new loot(src)
	else
		var/list/looty = loot
