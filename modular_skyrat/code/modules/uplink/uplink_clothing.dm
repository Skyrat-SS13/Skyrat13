/datum/uplink_item/suits/truedab
	...
	desc = "Ever found a cheap replica of one of these? Get to wear the real thing, everybody will think it's a fake! Has about as much protection as riot armor."
