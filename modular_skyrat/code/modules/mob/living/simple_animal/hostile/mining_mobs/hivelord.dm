/mob/living/simple_animal/hostile/asteroid/hivelord/legion
	...
	glorymessagespkabayonet = list("stabs the legion's gut and pulls out their regenerative core!", "repeatedly stabs the legion in their \"head\" with the PKA's bayonet!")
