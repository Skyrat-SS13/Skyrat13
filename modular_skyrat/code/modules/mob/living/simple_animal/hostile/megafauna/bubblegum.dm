...
/mob/living/simple_animal/hostile/megafauna/bubblegum
	...
	do_footstep = TRUE
	songs = list("1860" = sound('modular_skyrat/sound/ambience/bfgdivision.ogg', 100), "2070" = sound('modular_skyrat/sound/ambience/theonlythingtheyfearisyou.ogg', 100)) //Thanks Mr. Infringio!
