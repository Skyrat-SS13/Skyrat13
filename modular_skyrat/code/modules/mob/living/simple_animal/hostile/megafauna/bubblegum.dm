...
/mob/living/simple_animal/hostile/megafauna/bubblegum
	...
	do_footstep = TRUE
	songs = list("1860" = sound(file = 'modular_skyrat/sound/ambience/bfgdivision.ogg', volume = 100, channel = CHANNEL_AMBIENCE), "2070" = sound(file = 'modular_skyrat/sound/ambience/theonlythingtheyfearisyou.ogg', volume = 100, channel = CHANNEL_AMBIENCE)) //Thanks Mr. Infringio!
