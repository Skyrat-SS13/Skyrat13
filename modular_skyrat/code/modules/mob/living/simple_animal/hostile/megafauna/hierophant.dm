/mob/living/simple_animal/hostile/megafauna/hierophant
	...
	songs = list("2610" = sound('modular_skyrat/sound/ambience/dummyremix.ogg', 100), "1680" = sound('modular_skyrat/sound/ambience/rollermobster.ogg', 100)) //Dummy originally made by Toby Fox, remix by Emsdache. Roller Mobster by Carpenter Brut.
