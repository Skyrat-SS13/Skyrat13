/mob/living/simple_animal/hostile/megafauna/hierophant
	...
	songs = list("2610" = sound(file = 'modular_skyrat/sound/ambience/dummyremix.ogg', volume = 100, channel = CHANNEL_AMBIENCE), "1680" = sound(file = 'modular_skyrat/sound/ambience/rollermobster.ogg', volume = 100, channel = CHANNEL_AMBIENCE)) //Dummy originally made by Toby Fox, remix by Emsdache. Roller Mobster by Carpenter Brut.
