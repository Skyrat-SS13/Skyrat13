/mob/living/simple_animal/hostile/megafauna/rogueprocess
	...
	mob_biotypes = MOB_ROBOTIC
	songs = list("2930" = sound(file = 'modular_skyrat/sound/ambience/mbrsystemshock.ogg', repeat = 0, wait = 0, volume = 70, channel = CHANNEL_JUKEBOX)) //System shock theme remix by Master Boot Record
	var/special = FALSE
	wander = FALSE
