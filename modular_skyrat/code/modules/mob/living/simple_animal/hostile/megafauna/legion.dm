/mob/living/simple_animal/hostile/megafauna/legion
	...
	songs = list("3550" = sound('modular_skyrat/sound/ambience/mastermind.ogg', 100), "1360" = sound('modular_skyrat/sound/ambience/terrariaboss1.ogg', 100), "1560" = sound('modular_skyrat/sound/ambience/megalovania.ogg', 100)) //Threading on some lines here with the DOOM 16 OST. But terraria should be fine, megalovania too.
