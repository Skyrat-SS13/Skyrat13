/mob/living/simple_animal/hostile/megafauna/legion
	...
	songs = list("3550" = sound(file = 'modular_skyrat/sound/ambience/mastermind.ogg', volume = 100, channel = CHANNEL_AMBIENCE), "1360" = sound(file = 'modular_skyrat/sound/ambience/terrariaboss1.ogg', volume = 100, channel = CHANNEL_AMBIENCE), "1560" = sound('modular_skyrat/sound/ambience/megalovania.ogg', volume = 100, channel = CHANNEL_AMBIENCE)) //Threading on some lines here with the DOOM 16 OST. But terraria should be fine, megalovania too.
