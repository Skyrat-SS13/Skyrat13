/mob/living/simple_animal/hostile/megafauna/blood_drunk_miner
	...
	songs = list("2360" = sound(file = 'modular_skyrat/sound/ambience/igneon-system-and-death-machine-sins.ogg', repeat = 0, wait = 0, volume = 100, channel = CHANNEL_AMBIENCE), "2440" = sound(file = 'modular_skyrat/sound/ambience/machinegirl_excruciatingdeath.ogg', repeat = 0, wait = 0, volume = 100, channel = CHANNEL_AMBIENCE)) // I don't actually know if any of this is copyright free or CC. Fuck.
