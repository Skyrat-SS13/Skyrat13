/mob/living/simple_animal/hostile/megafauna/dragon
	songs = list("1860" = sound(file = 'modular_skyrat/sound/ambience/duskcreations.ogg', volume = 100, channel = CHANNEL_AMBIENCE), "2350" = sound(file = 'modular_skyrat/sound/ambience/dragonborn.ogg', volume = 100, channel = CHANNEL_AMBIENCE)) // Andrew is a nice guy, he'll let it slide. Taken from the DUSK OST. Not sure about the skyrim theme though...
