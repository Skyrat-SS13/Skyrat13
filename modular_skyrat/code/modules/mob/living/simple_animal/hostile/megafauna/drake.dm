/mob/living/simple_animal/hostile/megafauna/dragon
	songs = list("1860" = sound('modular_skyrat/sound/ambience/duskcreations.ogg', 100), "2350" = sound('modular_skyrat/sound/ambience/dragonborn.ogg', 100)) // Andrew is a nice guy, he'll let it slide. Taken from the DUSK OST. Not sure about the skyrim theme though...
