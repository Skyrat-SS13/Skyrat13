/mob/living/simple_animal/hostile/megafauna/colossus
	songs = list("1170" = sound(file = 'modular_skyrat/sound/ambience/theopenedway.ogg', repeat = 0, wait = 0, volume = 70, channel = CHANNEL_JUKEBOX)) //Shadow of the colossus OST
