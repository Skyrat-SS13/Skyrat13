/mob/living/simple_animal/hostile/megafauna/colossus
	songs = list("1170" = sound(file = 'modular_skyrat/sound/ambience/theopenedway.ogg', repeat = 0, wait = 0, volume = 100, channel = CHANNEL_AMBIENCE)) //Shadow of the colossus OST
