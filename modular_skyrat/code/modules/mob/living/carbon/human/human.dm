/mob/living/carbon/human/Topic(href, href_list)
	...
	if(href_list["skyrat_ooc_notes"])
		if(client)
			var/list/str = "[src]'s OOC Notes : <br> <b>ERP :</b> [client.prefs.erppref] <b>| Non-Con :</b> [client.prefs.nonconpref] <b>| Vore :</b> [client.prefs.vorepref]"
			...
			popup.set_content(text("<HTML><HEAD><TITLE>[]</TITLE></HEAD><BODY><TT>[]</TT></BODY></HTML>", "[name]'s OOC information", replacetext(str.Join(), "\n", "<BR>")))
			popup.open()
			return
