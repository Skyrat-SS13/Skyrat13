/obj/item/hhmirror
	...
	icon = 'modular_skyrat/icons/obj/hhmirror.dmi'
	icon_state = "hhmirror"
...
/obj/item/hhmirror/attack_self(mob/user)
	...
	if(ishuman(user))
		...
		H.update_hair()
/* It creates runtimes... I dont want runtimes right now
/obj/item/hhmirror/magic
...
/obj/item/hhmirror/magic/attack_self(mob/user)
	. = ..()
	if(.)
		return
	if(!ishuman(user))
	...
	if(charges == 0)
		qdel(src)
		to_chat(user, "The mirror crumbles into dust in your hand")
		return
*/