...
/obj/item/card/id/department
	name = "generic ID"
	desc = "A generic ID card, you feel wrong looking at this."
...
/obj/item/card/id/department/cargo
	name = "cargo identification card"
	desc = "A cargo ID card."
	icon_state = "cargo"
	item_state = "cargo-id"

/obj/item/card/id/department/cargo/head
	name = "cargo identification card"
	desc = "A cargo ID card."
	icon_state = "cargohead"

/obj/item/card/id/department/eng
	name = "engineering identification card"
	desc = "An engineering ID card."
	icon_state = "eng"
	item_state = "eng-id"

/obj/item/card/id/department/med
	name = "medical identification card"
	desc = "A medical ID card."
	icon_state = "med"
	item_state = "med-id"

/obj/item/card/id/department/sci
	name = "science identification card"
	desc = "A science ID card."
	icon_state = "sci"
	item_state = "sci-id"

/obj/item/card/id/department/sec
	name = "security identification card"
	desc = "A security ID card."
	icon_state = "sec"
	item_state = "sec-id"
