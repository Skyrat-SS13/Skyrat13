...
/obj/item/bspipe_dispenser/New()
	. = ..()
	spark_system = new /datum/effect_system/spark_spread
	spark_system.set_up(1, 0, src)
	spark_system.attach(src)
	if(!first_atmos)
		first_atmos = GLOB.bsatmos_pipe_recipes[GLOB.bsatmos_pipe_recipes[1]][1]
	if(!first_disposal)
...
/obj/item/bspipe_dispenser/Destroy()
	qdel(spark_system)
	spark_system = null
	return ..()

/obj/item/bspipe_dispenser/attack_self(mob/user)
	ui_interact(user)

/obj/item/bspipe_dispenser/suicide_act(mob/user)
...
/obj/item/bspipe_dispenser/ui_base_html(html)
	var/datum/asset/spritesheet/assets = get_asset_datum(/datum/asset/spritesheet/pipes)
	. = replacetext(html, "<!--customheadhtml-->", assets.css_tag())

/obj/item/bspipe_dispenser/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, force_open = FALSE, \
...
/obj/item/bspipe_dispenser/ui_data(mob/user)
	var/list/data = list(
		"category" = category,
...
/obj/item/bspipe_dispenser/ui_act(action, params)
	if(..())
		return
...
/obj/item/bspipe_dispenser/pre_attack(atom/A, mob/user)
...
/obj/item/bspipe_dispenser/proc/activate()
