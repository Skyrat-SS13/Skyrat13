//Buzz: A space explorer's best companion. Decently armored civillian space exploration mech, equipped with ion thrusters.
//Now you might ask: why the fuck is this another fucking subtype of ripley
//Because of the clamp. And the cargo. That is it.
/obj/mecha/working/ripley/buzz
	...
	deflect_chance = 20 //Better than a ripley by 5 points
	step_energy_drain = 6
...
/obj/mecha/working/ripley/buzz/update_pressure()
	...
	if(lavaland_equipment_pressure_check(T))
		for(var/obj/item/mecha_parts/mecha_equipment/funny in equipment)
			funny.equip_cooldown = initial(funny.equip_cooldown)/3 // Even our clamp and other stuff is better in space! ...or lavaland. Or depressurized rooms. You get it.
	else
		for(var/obj/item/mecha_parts/mecha_equipment/funny in equipment)
			funny.equip_cooldown = initial(funny.equip_cooldown)
