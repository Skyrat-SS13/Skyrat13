/obj/machinery/reagent_material_manipulator
	name = "necropolis material manipulation machine"
	desc = "A somehow high tech machine that can both analyse material traits and combine material traits with each other."
