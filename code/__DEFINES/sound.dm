...
#define CHANNEL_EAR_RING 1006

//THIS SHOULD ALWAYS BE THE LOWEST ONE!
//KEEP IT UPDATED

#define CHANNEL_HIGHEST_AVAILABLE 1005 //CIT CHANGE - COMPENSATES FOR VORESOUND CHANNELS - SKYRAT CHANGE - COMPENSATES FOR FUNNY COMBAT MUSIC
