...
#define BLOB_REROLL_TIME 1200 // blob gets a free reroll every X time SKYRAT EDIT - BLOB
//#define BLOB_SPREAD_COST 4
#define BLOB_SPREAD_COST 2 //SKYRAT EDIT - BLOB
//#define BLOB_ATTACK_REFUND 3 //blob refunds this much if it attacks and doesn't spread also SKYRAT CHANGE FROM 2
#define BLOB_ATTACK_REFUND 1 //blob refunds this much if it attacks and doesn't spread also SKYRAT EDIT - BLOB
