...
#define WOUND_SEVERITY_PSYCHOLOGICAL 1 // for wounds that are really just insanity induced (e.g. spaghetti arms)
#define WOUND_SEVERITY_TRIVIAL	2 // for jokey/meme wounds like stubbed toe, no standard messages/sounds or second winds
#define WOUND_SEVERITY_MODERATE	3
#define WOUND_SEVERITY_SEVERE	4
#define WOUND_SEVERITY_CRITICAL	5
...
#define WOUND_SEVERITY_LOSS		7 // theoretical total limb loss, like dismemberment for cuts
...
//	1. Skin is mangled: At least a trivial slash or pierce wound
...
#define BODYPART_MANGLED_MUSCLE 3
#define BODYPART_MANGLED_BOTH	4
