...
#define JOB_SKILLPOINTS_AVERAGE 15
#define JOB_SKILLPOINTS_TRAINED 20
#define JOB_SKILLPOINTS_EXPERT 25
#define JOB_SKILLPOINTS_LEGENDARY 30
...
#define JOB_STATPOINTS_EXPERT 15
