...
#define JOB_SKILLPOINTS_NOVICE 10
#define JOB_SKILLPOINTS_TRAINED 15
#define JOB_SKILLPOINTS_EXPERT 20
#define JOB_SKILLPOINTS_LEGENDARY 25

//Job stat point allocation
#define JOB_STATPOINTS_HORRENDOUS 1
#define JOB_STATPOINTS_WORTHLESS 5
#define JOB_STATPOINTS_NOVICE 8
#define JOB_STATPOINTS_TRAINED 10
#define JOB_STATPOINTS_EXPERT 12
#define JOB_STATPOINTS_LEGENDARY 15
