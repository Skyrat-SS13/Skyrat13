...
#define METRIC_OR_BUST			(1<<18) // Skyrat - Metric measurements for those who are not insane
...
#define CHAT_LOOC_ADMIN		(1<<12) /*Skyrat Change - allows admins to toggle global looc/local looc*/

#define TOGGLES_DEFAULT_CHAT (CHAT_OOC|CHAT_DEAD|CHAT_GHOSTEARS|CHAT_GHOSTSIGHT|CHAT_PRAYER|CHAT_RADIO|CHAT_PULLR|CHAT_GHOSTWHISPER|CHAT_GHOSTPDA|CHAT_GHOSTRADIO|CHAT_LOOC|CHAT_BANKCARD|CHAT_LOOC_ADMIN) /*Skyrat change - adds global looc for admins to normal chat*/
