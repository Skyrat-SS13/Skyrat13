...
#define ROUNDEND_CKEY			(1<<18) // Skyrat - Hide/show ckey on round end stats

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|MEMBER_PUBLIC|INTENT_STYLE|MIDROUND_ANTAG|SOUND_INSTRUMENTS|SOUND_SHIP_AMBIENCE|SOUND_PRAYERS|SOUND_ANNOUNCEMENTS|ASYNCHRONOUS_SAY|ROUNDEND_CKEY) //Skyrat change - added ASYNCHRONOUS_SAY
