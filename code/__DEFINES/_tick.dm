...
/// Returns true if tick usage is above 25, for low priority usage
#define TICK_CHECK_LOW_PRIORITY ( TICK_USAGE > 25 )
/// runs stoplag if tick_usage is above 25, for low priority usage
