...
/// Returns true if tick usage is above 30, for low priority usage
#define TICK_CHECK_LOW_PRIORITY ( TICK_USAGE > 30 )
/// runs stoplag if tick_usage is above 30, for low priority usage
