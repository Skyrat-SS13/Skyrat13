...
/datum/game_mode/traitor
	...
	announce_text = "There are disloyal crew on the station!\n\
...
/datum/game_mode/traitor/generate_report()
	return "Although more specific threats are commonplace, you should always remain vigilant for disloyal employees aboard your station. External communications have implied that some \
		Nanotrasen employees are disloyal renegades or even espionage agents with goals that go against the company. Deal with them as non-lethally as possible and extract information.."
