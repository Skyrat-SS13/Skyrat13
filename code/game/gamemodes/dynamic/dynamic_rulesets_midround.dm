...
/datum/dynamic_ruleset/midround/malf
	...
	enemy_roles = list("Security Officer", "Warden","Detective","Head of Security", "Captain", "Scientist", "Chemist", "Research Director", "Chief Engineer", "Blueshield") //Skyrat changes adds Blue to list
...
/datum/dynamic_ruleset/midround/incursion
	name = "Syndicate Incursion Sleeper"
...
/datum/dynamic_ruleset/midround/incursion/trim_candidates()
	..()
...
/datum/dynamic_ruleset/midround/incursion/execute()
