...
/datum/game_mode/nuclear/generate_report()
	return "One of Central Command's trading routes was recently disrupted by a raid carried out by a well known terrorist organization. They seemed to only be after one ship - a highly-sensitive \
