...
//	new /obj/item/circuitboard/machine/techfab/department/service(src) //Skyrat change
...
//	new /obj/item/circuitboard/machine/techfab/department/security(src) // Skyrat change
