...
//	new /obj/item/circuitboard/machine/techfab/department/service(src) //Skyrat change, go to science nerds
...
//	new /obj/item/circuitboard/machine/techfab/department/security(src) //Skyrat change, go to science nerds
