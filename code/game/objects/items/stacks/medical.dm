...
/obj/item/stack/medical/proc/heal_carbon(mob/living/carbon/C, mob/user, brute, burn)
	...
	if(!affecting) //Missing limb?
		...
		return
	if(affecting.status == BODYPART_ORGANIC && affecting.species_id != "synth") //Limb must be organic to be healed - RR
		...
		return
	to_chat(user, "<span class='notice'>\The [src] won't work on a [affecting.species_id == "synth" ? "synthetic" : "robotic"] limb!</span>")
