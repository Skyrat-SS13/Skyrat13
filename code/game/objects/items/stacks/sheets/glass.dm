...
GLOBAL_LIST_INIT(glass_recipes, list ( \
	...
	new/datum/stack_recipe("fulltile window", /obj/structure/window/fulltile/unanchored, 2, time = 0, on_floor = TRUE, window_checks = TRUE, low_wall_check = TRUE), \
	null, \
...
GLOBAL_LIST_INIT(pglass_recipes, list ( \
	...
	new/datum/stack_recipe("fulltile window", /obj/structure/window/plasma/fulltile/unanchored, 2, time = 0, on_floor = TRUE, window_checks = TRUE, low_wall_check = TRUE) \
))
...
GLOBAL_LIST_INIT(reinforced_glass_recipes, list ( \
	...
	new/datum/stack_recipe("fulltile reinforced window", /obj/structure/window/reinforced/fulltile/unanchored, 2, time = 0, on_floor = TRUE, window_checks = TRUE, low_wall_check = TRUE) \
))
...
GLOBAL_LIST_INIT(prglass_recipes, list ( \
	...
	new/datum/stack_recipe("fulltile reinforced window", /obj/structure/window/plasma/reinforced/fulltile/unanchored, 2, time = 0, on_floor = TRUE, window_checks = TRUE, low_wall_check = TRUE) \
))
