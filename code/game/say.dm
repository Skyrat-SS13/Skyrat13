...
/atom/movable/proc/Hear(message, atom/movable/speaker, message_language, raw_message, radio_freq, list/spans, message_mode, atom/movable/source, maptext_popup = TRUE) //Skyrat change - extra var for runechat
...
/atom/movable/proc/lang_treat(atom/movable/speaker, datum/language/language, raw_message, list/spans, message_mode, no_quote = FALSE) //Skyrat change
	if(has_language(language))
		var/atom/movable/AM = speaker.GetSource()
		if(AM) //Basically means "if the speaker is virtual"
			return no_quote ? raw_message : AM.say_quote(raw_message, spans, message_mode) //Skyrat change
		else
			return no_quote ? raw_message : speaker.say_quote(raw_message, spans, message_mode) //Skyrat change
	else if(language)
		var/atom/movable/AM = speaker.GetSource()
