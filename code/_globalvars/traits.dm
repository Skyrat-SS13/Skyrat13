...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		//skyrat traits
		"TRAIT_ALCOHOL_LIGHTWEIGHT" = TRAIT_ALCOHOL_LIGHTWEIGHT,
		"TRAIT_NICE_SHOT" = TRAIT_NICE_SHOT,
		"TRAIT_HARD_SOLES" = TRAIT_HARD_SOLES,
		"TRAIT_SCREWY_MOOD" = TRAIT_SCREWY_MOOD,
		"TRAIT_SCREWY_CHECKSELF" = TRAIT_SCREWY_CHECKSELF,
		"TRAIT_HEMOPHILIA" = TRAIT_HEMOPHILIA,
		"TRAIT_ASTHMATIC" = TRAIT_ASTHMATIC,
		//
