...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_ALCOHOL_LIGHTWEIGHT" = TRAIT_ALCOHOL_LIGHTWEIGHT, //Skyrat change
		...
		"TRAIT_CLEANFOOT" = TRAIT_CLEANFOOT, // SKYRAT EDIT - SANITARY
		"TRAIT_DIRTYFOOT" = TRAIT_DIRTYFOOT, // SKYRAT EDIT - SANITARY
