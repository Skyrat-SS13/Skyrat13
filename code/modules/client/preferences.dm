...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_tab)
		...
		if(2)
			...
			dat += 	"<b>Faction/Employer:</b> <a href='?_src_=prefs;preference=flavor_faction;task=input'>[flavor_faction ? flavor_faction : "None"]</a><br>"
			dat += "<b>Traitor employer:</b> <a href='?_src_=prefs;preference=syndi_faction;task=menu'>[syndi_faction ? syndi_faction : "None"]</a><br>"
