...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_tab)
		...
		if(4) // Content preferences
			...
			dat += "<b>Allow Lewd Verbs:</b> <a href='?_src_=prefs;preference=verb_consent'>[(cit_toggles & VERB_CONSENT) ? "Yes":"No"]</a><br>" // Skyrat - ERP Mechanic Addition
		...
		if("input")
			...
			switch(href_list["preference"])
				...
				if("verb_consent") // Skyrat - ERP Mechanic Addition
					cit_toggles ^= VERB_CONSENT // Skyrat - ERP Mechanic Addition
