...
/datum/preferences/proc/SetSpeech(mob/user)
	...
	dat += "Format: <span style='padding-left: 10px;color: #a899ff;'>You start (soundtext).</span><br>"
	dat += "Example: <span style='padding-left: 10px;color: #a899ff;'>\"You start speaking differently.\"</span><br>"
