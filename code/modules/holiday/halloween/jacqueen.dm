			...
			switch(choice)
				...
				if("What is that on your head?")
					...
					//Year1
						...
						jacqrunes("This thing? This ain't nae ordinary pumpkin! Me Ma grew this monster ooer a year o love, dedication an hard work. Honestly it felt like she loved this thing more than any of us, which Ah knew ain't true an it's not like she was hartless or anything but.. well, we had a falling oot when Ah got back home with all me stuff in tow. An all she had done is sent me owl after owl over t' last year aboot this bloody pumpkin and ah had enough. So ah took it, an put it on me head. You know, as ye do. Ah am the great Pumpqueen after all, Ah deserve this.", C)

					else
						visible_message("<b>[src]</b> groans, <span class='spooky'>\"I'm missing me bloody lines! Least ye ken do is maintain me like!\"</span>")
						jacqrunes("I'm missing me bloody lines! Least ye ken do is maintain me like!", C)
				...
				if("Are you a witch?")
					...
					//Year1
						...
						jacqrunes("If ye must know, Ah got kicked oot of the witch academy fer being too much of a \"loose cannon\". A bloody loose cannon? Nae they were just pissed off Ah had the brass tae proclaim myself as the Pumpqueen! And also maybe the time Ah went and blew up one of the towers by trying tae make a huge batch of astrogen might've had something tae do with it. Ah mean it would've worked fine if the cauldrons weren't so shite and were actually upgraded by the faculty. So technically no, I'm not a witch." , C)
				...
				if("What is it like being a witch?") //Year 2 only
				...
				if("So you got ex-spell-ed?") //Year 1 only
