...
/obj/item/projectile
	...
	var/hitscan_light_range = 0 //SKYRAT CHANGE - temporary removal for performance
	var/hitscan_light_color_override
	var/muzzle_flash_intensity = 3
	var/muzzle_flash_range = 0 //SKYRAT CHANGE - temporary removal for performance
	var/muzzle_flash_color_override
	var/impact_light_intensity = 3
	var/impact_light_range = 0 //SKYRAT CHANGE - temporary removal for performance
