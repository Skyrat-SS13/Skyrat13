...
/obj/machinery/vending/cola/buzz_fuzz
	...
	product_ads = "Stinging flavour!;Ideal of the worker drone!;Buzz Buzz!;Got Honey?;The Queen approves of this drink!;Sap back that missing energy!;Bee the consumer unit!;1, 2, Buzz, 4, Fuzz, Buzz Fuzz!" //Skyrat edit - fizz buzz funny joke
	//skyrat edit
	brand = "Shambler's Drinks"
	//
