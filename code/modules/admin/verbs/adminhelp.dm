...
/datum/admin_help/proc/ICIssue(key_name = key_name_admin(usr))
	...
	msg += "<font color='red'>If it is indeed an OOC issue, please provide further information and context along with evidence showing that it is an OOC issue.</font>" // Skyrat Change
