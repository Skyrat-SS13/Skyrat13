...
/turf/proc/lighting_clear_overlay()
	if (lighting_object)
		SSrecycling.recycle_movable_lighting_object(lighting_object, TRUE)
...
/turf/proc/lighting_build_overlay()
	if (lighting_object)
		SSrecycling.recycle_movable_lighting_object(lighting_object,force=TRUE) //Shitty fix for lighting objects persisting after death
	...
	SSrecycling.deploy_movable_lighting_object(src)
