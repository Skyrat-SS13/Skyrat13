...
/datum/design/lefthand
	...
	build_type = LIMBGROWER
	reagents_list = list(/datum/reagent/medicine/synthflesh = 25)
	build_path = /obj/item/bodypart/l_arm/l_hand
	category = list("initial","human","lizard","fly","insect","plasmaman","mammal","xeno")
...
/datum/design/righthand
	...
	build_type = LIMBGROWER
	reagents_list = list(/datum/reagent/medicine/synthflesh = 25)
	build_path = /obj/item/bodypart/r_arm/r_hand
	category = list("initial","human","lizard","fly","insect","plasmaman","mammal","xeno")
...
/datum/design/leftfoot
	...
	build_type = LIMBGROWER
	reagents_list = list(/datum/reagent/medicine/synthflesh = 25)
	build_path = /obj/item/bodypart/l_leg/l_foot
	category = list("initial","human","lizard","fly","insect","plasmaman","mammal","xeno")
...
/datum/design/rightleg
	...
	build_type = LIMBGROWER
	reagents_list = list(/datum/reagent/medicine/synthflesh = 25)
	build_path = /obj/item/bodypart/r_leg/r_foot
	category = list("initial","human","lizard","fly","insect","plasmaman","mammal","xeno")
