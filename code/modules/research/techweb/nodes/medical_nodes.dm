...
/datum/techweb_node/adv_surgery
	...
	design_ids = list("surgery_revival", "surgery_lobotomy", "surgery_heal_brute_upgrade_femto","surgery_heal_burn_upgrade_femto", "surgery_heal_combo", "surgery_toxinhealing", "organbox", "surgery_adv_dissection", "bonesetter", "bonegel", "fixovein")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
