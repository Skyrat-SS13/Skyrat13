...
/datum/techweb_node/robotics
	...
	design_ids = list("paicard", "drone_shell", "arm_cord")
...
/datum/techweb_node/cyborg
	...
	design_ids = list("robocontrol", "sflash", "borg_suit", "borg_head", "borg_chest", "borg_groin", "borg_r_arm", "borg_l_arm", "borg_r_leg", "borg_l_leg", "borgupload",
