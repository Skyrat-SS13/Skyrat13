...
/mob/living/simple_animal/hostile/eldritch/ash_spirit
	...
	melee_damage_upper = 20
	sight = SEE_TURFS
	spells_to_add = list(/obj/effect/proc_holder/spell/targeted/ethereal_jaunt/shift/ash,/obj/effect/proc_holder/spell/targeted/cleave/long,/obj/effect/proc_holder/spell/aoe_turf/fire_cascade)
