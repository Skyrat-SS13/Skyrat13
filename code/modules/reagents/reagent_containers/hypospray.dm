...
/obj/item/reagent_containers/hypospray/medipen
	...
	flags_1 = null
	list_reagents = list(/datum/reagent/medicine/epinephrine = 10, /datum/reagent/medicine/preservahyde = 3, /datum/reagent/medicine/coagulant = 2) // Skyrat Edit - repaths preservahyde
