...
/datum/controller/subsystem/processing/circuit/proc/circuits_init()
	...
	circuit_fabricator_recipe_list["Assemblies"] = list(
		...
		/obj/item/electronic_assembly/dildo,	//Skyrat Edit
		...
		/obj/item/electronic_assembly/small/dildo,	//Skyrat Edit
		...
		/obj/item/electronic_assembly/medium/dildo,	//Skyrat Edit
