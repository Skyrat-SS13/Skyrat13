...
/datum/controller/subsystem/mapping/Initialize(timeofday)
	...
	while (snowy_levels_so_far < config.snowy_ruin_levels)
		++snowy_levels_so_far
		add_new_zlevel("Empty Area [snowy_levels_so_far]", ZTRAITS_SNOWY)
	while (snowy_underground_levels_so_far < config.snowy_underground_ruin_levels)
		++snowy_underground_levels_so_far
		add_new_zlevel("Empty Area [snowy_underground_levels_so_far]", ZTRAITS_SNOWY_UNDERGROUND)
	// and one space level with no ruins
